...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_companies_check_company_name_not_empty"),
        ),
        sa.CheckConstraint(
            "length(industry) > 0", name=op.f("ck_companies_check_industry_not_empty")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_companies")),
    )
    op.create_index(
        op.f("ix_companies_company_name"), "companies", ["company_name"], unique=True
    )
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_educational_institutions_check_institution_name_not_empty"),
        ),
        sa.CheckConstraint(
            "length(location) > 0",
            name=op.f("ck_educational_institutions_check_location_not_empty"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_educational_institutions")),
    )
    op.create_index(
        op.f("ix_educational_institutions_institution_name"),
        "educational_institutions",
        ["institution_name"],
        unique=True,
    )
    op.create_index(
        op.f("ix_educational_institutions_institution_type"),
        "educational_institutions",
        ["institution_type"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "role_name",
            sa.Enum("Соискатель", "Работодатель", name="role_enum"),
            nullable=False,
        ),
        sa.Column("id", advanced_alchemy.types.guid.GUID(length=16), nullable=False),
        sa.Column("sa_orm_sentinel", sa.Integer(), nullable=True),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "email LIKE '%@%.%'", name=op.f("ck_users_check_email_format")
        ),
        sa.CheckConstraint(
            "length(first_name) > 0", name=op.f("ck_users_check_first_name_not_empty")
        ),
        sa.CheckConstraint(
            "length(last_name) > 0", name=op.f("ck_users_check_last_name_not_empty")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role_id", advanced_alchemy.types.guid.GUID(length=16), nullable=False
        ),
        sa.Column("id", advanced_alchemy.types.guid.GUID(length=16), nullable=False),
        sa.Column("sa_orm_sentinel", sa.Integer(), nullable=True),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("sa_orm_sentinel", sa.Integer(), nullable=True),
        sa.CheckConstraint(
            "length(degree) > 0", name=op.f("ck_education_check_degree_not_empty")
        ),
        sa.CheckConstraint(
            "length(field_of_study) > 0",
            name=op.f("ck_education_check_field_of_study_not_empty"),
        ),
        sa.CheckConstraint(
            "start_year <= end_year OR end_year IS NULL",
            name=op.f("ck_education_check_year_order"),
        ),
        sa.ForeignKeyConstraint(
            ["cv_id"],
            ["cvs.id"],
            name=op.f("fk_education_cv_id_cvs"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["institution_id"],
            ["educational_institutions.id"],
            name=op.f("fk_education_institution_id_educational_institutions"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_education_institution_id"),
        "education",
        ["institution_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("cv_id", advanced_alchemy.types.guid.GUID(length=16), nullable=False),
        sa.Column(
            "company_id", advanced_alchemy.types.guid.GUID(length=16), nullable=False
        ),
        ...
        sa.CheckConstraint(
            "length(job_title) > 0",
            name=op.f("ck_work_experience_check_job_title_not_empty"),
        ),
        sa.CheckConstraint(
            "start_date <= end_date OR end_date IS NULL",
            name=op.f("ck_work_experience_check_date_order"),
        ),
        sa.ForeignKeyConstraint(
            ["company_id"],
            ["companies.id"],
            name=op.f("fk_work_experience_company_id_companies"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["cv_id"],
            ["cvs.id"],
            name=op.f("fk_work_experience_cv_id_cvs"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_work_experience_company_id"),
        "work_experience",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_work_experience_cv_id"), "work_experience", ["cv_id"], unique=False
    )
    op.create_index(
        op.f("ix_work_experience_employment_type"),
        "work_experience",
        ["employment_type"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_work_experience_employment_type"), table_name="work_experience"
    )
